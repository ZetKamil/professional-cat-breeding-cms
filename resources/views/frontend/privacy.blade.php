<x-frontend.shell
    title="Polityka Prywatności — Hodowla Kotów z Mazowieckiej Szwajcarii"
    ...
    <div class="section tile-canvas legal-page">
        <div class="section-inner legal-page__inner">
            ...
            <header class="legal-page__header">
                <span class="text-eyebrow legal-page__version">Wersja 1.1</span>
            ...
            <article class="legal-page__article">
                ...
                <section class="legal-page__section">
                    <h2 class="legal-page__section-title">1. Kto jest Administratorem Danych?</h2>
                    <p>Administratorem Twoich danych osobowych zbieranych za pośrednictwem strony internetowej jest <strong>Hodowla Kotów z Mazowieckiej Szwajcarii</strong>. Możesz skontaktować się z nami pisząc na adres e-mail: hodowla.z.mazowieckiej.szwajcarii@gmail.com, dzwoniąc pod numer: +48514153204, lub pisemnie na adres: Sikórz 56A, 09-413 Sikórz, Polska.</p>
                </section>
                ...
                <section class="legal-page__section">
                    <h2 class="legal-page__section-title">3. Komu udostępniamy Twoje dane?</h2>
                    <p>Twoje dane osobowe mogą być przekazywane wyłącznie zaufanym podmiotom, z którymi współpracujemy, takim jak dostawca hostingu naszej strony czy obsługi technicznej, wyłącznie w zakresie niezbędnym do jej funkcjonowania. Gwarantujemy, że <strong>nigdy nie sprzedajemy</strong> Twoich danych podmiotom trzecim.</p>
                </section>

                <section class="legal-page__section">
                    <h2 class="legal-page__section-title">4. Jak długo przechowujemy dane?</h2>
                    <p>Dane zebrane w celu obsługi zapytań przechowujemy przez okres niezbędny do udzielenia odpowiedzi, zakończenia korespondencji oraz ewentualnego zabezpieczenia roszczeń (nie dłużej niż wynika to z obowiązujących przepisów prawa).</p>
                </section>

                <section class="legal-page__section">
                    <h2 class="legal-page__section-title">5. Twoje prawa (RODO)</h2>
            ...
            <div class="legal-page__footer">
                <p class="text-body text-ink-muted-48">Ostatnia aktualizacja: 31.07.2026</p>
            </div>
