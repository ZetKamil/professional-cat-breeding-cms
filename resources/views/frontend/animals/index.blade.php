<x-frontend.shell
    ...
    meta-description="Przeglądaj koty hodowlane i dostępne kocięta w naszej hodowli. Zdrowe linie genetyczne, komplet badań rodziców dedykowanych rasie, rodowód SHiOZ ZOOLANDIA i domowa socjalizacja."
