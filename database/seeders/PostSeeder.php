    ...
    public function run(): void
    {
        ...
        $posts = [
            ...
            [
                ...
                'body' => "Kot Brytyjski Krótkowłosy (British Shorthair) to jedna z najbardziej cenionych ras na świecie. Их zrównoważony, spokojny temperament sprawia, że są idealnymi przyjaciółmi zarówno dla rodzin z dziećmi, jak i osób ceniących ciszę i spokój.\n\nW ZetKamil kładziemy szczególny nacisk na prawidłową budowę anatomiczną, gęsty podszerstek oraz głębokie, miedziane spojrzenie naszych brytyjczyków.",
                'is_published' => true,
